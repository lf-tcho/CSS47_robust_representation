...
def get_dataset(dataset_type,train_type,bs,color_jitter_strength):
    ...
    if dataset_type=='cifar-10':
        ...
        train_dst   = CIFAR10(root='/home/ubuntu/CSS/cifar-10-batches-py', train=True, download=True,
                                        transform=transform_train,contrastive_learning=learning_type)
        val_dst     = CIFAR10(root='/home/ubuntu/CSS/cifar-10-batches-py', train=False, download=True,
        ...
        if learning_type=='contrastive':
            ...
            train_loader = torch.utils.data.DataLoader(train_dst,batch_size=bs,num_workers=4,
                    pin_memory=False,
